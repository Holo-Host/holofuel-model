...
*** Holo Hosting Receipts 
    ...
    |------+-----------+---------------------------------------------------------------------------------|
    | 4.26 | 4.40-0.14 | 1.0000 holo Host, 0.0290 net TB, 0.0311 ram GB, 0.0060 data TB, 0.0151 cpu Core |
    | 4.45 | 4.60-0.14 | 1.0000 holo Host, 0.0208 net TB, 0.0095 ram GB, 0.0146 data TB, 0.0633 cpu Core |
    | 4.52 | 3.99+0.53 | 1.0000 holo Host, 0.0152 net TB, 0.0231 ram GB, 0.0087 data TB, 0.0373 cpu Core |
    | 5.01 | 4.59+0.42 | 1.0000 holo Host, 0.0243 net TB, 0.0639 ram GB, 0.0098 data TB, 0.0276 cpu Core |
    | 4.86 | 4.63+0.24 | 1.0000 holo Host, 0.0244 net TB, 0.0491 ram GB, 0.0105 data TB, 0.0424 cpu Core |
    |  ... |           |                                                                                 |
    :END:
    #+LATEX: }
...
*** Recovery of Commodity Valuations
    ...
    | Commodity   | Predicted | Actual |   Error |
    |-------------+-----------+--------+---------|
    | holo        |      2.61 |   2.61 | -0.193% |
    | net         |     44.15 |  44.28 | -0.284% |
    | ram         |      4.66 |   4.47 | +4.295% |
    | data        |     47.60 |  48.61 | -2.066% |
    | cpu         |      4.76 |   4.85 | -1.841% |
    :END:
...
*** Simple Host/dApp Pricing Model
    ...
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 0.233351                |    0.065407 |   0.000959 |   0.003641 |  0.000460 |   0.001480 |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 24hr. x 3600 Hosts Cost |             |            |            |           |            |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 22793.466819            | 5922.324433 | 119.558602 | 235.325051 | 59.594830 | 238.610280 |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Score(R^2) 0.9483829    |             |            |            |           |            |
    | Predicted               |        2.18 |      40.40 |       5.24 |     41.63 |       5.27 |
    | Actual                  |        2.26 |      40.50 |       4.66 |     39.94 |       4.59 |
    | Error                   |     -3.291% |    -0.239% |   +12.588% |   +4.233% |   +14.718% |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Actual  Basket          |       95.96 |            |            |           |            |
    | Predict Basket          |       95.73 |            |            |           |            |
    | Error                   |     -0.231% |            |            |           |            |
    :END:
    ...
    intervals (so, 6 x 1-hour regression samples per hour).
