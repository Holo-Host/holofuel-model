...
*** Simple Host/dApp Pricing Model
    ...
    #+BEGIN_SRC ipython :session :exports both :results value raw drawer
      ...
      class dApp( object ):
          def __init__( self, duration=duration_month ): # 1 mo., in seconds
              ...
              self.wealth = current_value( current_prices, self.requires ) / credit.K
      ...
      class credit_sine( credit_static ):
	      ...
	      amp		= self.sine_amp * math.sin( self.sine_theta )
              return super( credit_sine, self ).K + super( credit_sine, self ).K * amp

      # +/- .5% of credit.K,  1 cycle per 6 hours
      credit		= credit_sine( K=0.5, amp=.5/100, step=2 * math.pi / hosts_count / 6 )
    ...
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 0.254348                |    0.064048 |   0.000793 |   0.002440 |  0.001104 |   0.004156 |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 24hr. x 3600 Hosts Cost |             |            |            |           |            |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 21154.878336            | 5946.779804 | 119.117575 | 237.113196 | 59.528866 | 237.638864 |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Score(R^2) 0.9484825    |             |            |            |           |            |
    | Predicted               |        1.96 |      38.10 |       5.30 |     40.99 |       5.01 |
    | Actual                  |        2.03 |      38.22 |       4.75 |     39.36 |       4.49 |
    | Error                   |     -3.215% |    -0.309% |   +11.622% |   +4.157% |   +11.631% |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Actual  Basket          |       88.91 |            |            |           |            |
    | Predict Basket          |       88.70 |            |            |           |            |
    | Error                   |     -0.231% |            |            |           |            |
    :END:
