...
+ [ [ '...' ] ]
    ...
    |------+-----------+---------------------------------------------------------------------------------|
    | 3.80 | 3.27+0.53 | 1.0000 holo Host, 0.0188 net TB, 0.0399 ram GB, 0.0043 data TB, 0.0567 cpu Core |
    | 2.68 | 3.21-0.53 | 1.0000 holo Host, 0.0190 net TB, 0.0440 ram GB, 0.0049 data TB, 0.0317 cpu Core |
    | 3.30 | 3.80-0.50 | 1.0000 holo Host, 0.0233 net TB, 0.0845 ram GB, 0.0104 data TB, 0.0393 cpu Core |
    | 4.66 | 4.20+0.46 | 1.0000 holo Host, 0.0441 net TB, 0.0347 ram GB, 0.0125 data TB, 0.0431 cpu Core |
    | 3.04 | 3.10-0.06 | 1.0000 holo Host, 0.0000 net TB, 0.0552 ram GB, 0.0110 data TB, 0.0552 cpu Core |
    |  ... |           |                                                                                 |
    :END:
    #+LATEX: }
...
+ [ [ k, 
    ...
    | Commodity   | Predicted | Actual |   Error |
    |-------------+-----------+--------+---------|
    | holo        |      2.11 |   2.11 | -0.139% |
    | net         |     27.83 |  27.18 | +2.411% |
    | ram         |      5.53 |   5.57 | -0.704% |
    | data        |     39.74 |  40.38 | -1.582% |
    | cpu         |      4.55 |   4.41 | +3.111% |
    :END:
...
[ [ "%dhr. x %d Hosts Cost" % ( hours_count, hosts_count ) ] + list( rcpt.keys() ),
  ...
  [ "Error" , "%+5.3f%%" % (( predict_value - actual_value ) * 100 / actual_value ) ],
    ...
    |-------------------------+-------------+------------+------------+-----------+------------|
    | 20667.032563            | 5988.651699 | 120.620987 | 237.308410 | 59.391252 | 234.547756 |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Score(R^2) 0.9872771    |             |            |            |           |            |
    | Predicted               |        2.07 |      27.26 |       5.86 |     41.07 |       4.73 |
    | Actual                  |        2.11 |      27.18 |       5.57 |     40.38 |       4.41 |
    | Error                   |     -1.733% |    +0.300% |    +5.151% |   +1.711% |    +7.290% |
    |-------------------------+-------------+------------+------------+-----------+------------|
    | Actual  Basket          |       86.41 |            |            |           |            |
    | Predict Basket          |       86.31 |            |            |           |            |
    | Error                   |     -0.107% |            |            |           |            |
    :END:
